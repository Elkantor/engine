...
static const GuiStyleProp darkStyleProps[] = {
    ...
    { SLIDER, TEXT_COLOR_NORMAL, 0xEEEEEEff },
    { SLIDER, TEXT_COLOR_PRESSED, 0xEEEEEEff },
    { SLIDER, BASE_COLOR_FOCUSED, 0xEEEEEEff },
    { SLIDER, BORDER_COLOR_PRESSED, 0x121212ff },
};
...
static const RL_Rectangle darkFontRecs[189] = {
    { 4, 4, 4 , 16 },
    { 16, 4, 1 , 9 },
    { 25, 4, 3 , 3 },
    { 36, 4, 6 , 9 },
...
static void GuiLoadStyleDark(void)
{
    ...
    for (int i = 0; i < sizeof(darkStyleProps) / sizeof(darkStyleProps[0]); i++)
    {
    ...
    font.recs = (RL_Rectangle *)RAYGUI_MALLOC(font.glyphCount*sizeof(RL_Rectangle));
    memcpy(font.recs, darkFontRecs, font.glyphCount*sizeof(RL_Rectangle));
    ...
    RL_Rectangle fontWhiteRec = { 510, 254, 1, 1 };
